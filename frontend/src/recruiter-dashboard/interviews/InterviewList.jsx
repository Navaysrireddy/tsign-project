    ...
    <div className="overflow-x-auto">
      ...
      <div className="flex justify-end mb-3">
        <motion.button
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 text-white shadow-md"
        >
          <DownloadIcon size={16} />
          Download PDF
        </motion.button>
        ...
        <tbody>
          {interviews.length > 0 ? (
            interviews.map((interview) => (
              ...
              >
                <td className="p-4">{interview. tSignId}</td>
                <td className="p-4 font-medium">{interview.candidate}</td>
                <td className="p-4">{interview.position}</td>
                <td className="p-4">{interview.date}</td>
                <td className="p-4">{interview.time}</td>
