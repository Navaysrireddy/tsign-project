...
const Placements = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <table className="w-full text-sm text-left text-gray-700 dark:text-gray-300">
          ...
          <tbody>
            {companies
              ...
              .map((company) => {
                const counts = applicationStatusCounts[company.name] || {
                  accepted: 0,
                  rejected: 0,
                  pending: 0,
                  onHold: 0,
      ...
      {/* Graphs and Charts at the bottom */}
    
<div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-[0_10px_20px_rgba(0,0,0,0.05)] dark:shadow-[0_10px_20px_rgba(0,0,0,0.2)] border border-gray-100 dark:border-gray-700 mt-8">
  ...
  {/* 1st row: Application Status + Application Timeline */}
  ...
  {/* 2nd row: Salary Range + Companies Applied */}
