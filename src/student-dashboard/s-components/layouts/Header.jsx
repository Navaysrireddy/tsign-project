...
//                   </div>
//                   <div>
//                     <h3 className="font-semibold text-gray-800 dark:text-white">John Smith</h3>
//                     <p className="text-sm text-gray-500 dark:text-gray-400">john.smith@example.com</p>
//                     <p className="text-xs text-gray-500 dark:text-gray-400">Computer Science, Year 3</p>
//                   </div>
//                 </div>
//               </div>
//               <div className="py-2">
...
const Header = ({ toggleSidebar }) => {
  ...
  const handleLogout = () => {
    // You can add your logout logic here (e.g., clear auth tokens)
