...
const Register = () => {
  ...
  return (
    <div className="register-container">
      <h2>Unlock your journey – start by registering!</h2><hr class="custom-hr" />
          ...
          <div className="multi-step-form">
            ...
            {collegeStep === 2 && (
              <form onSubmit={(e) => { e.preventDefault(); nextCollegeStep(); }}>
                ...
                <div className="form-buttons">
                  <button type="button" className="prev-btn" onClick={prevCollegeStep}>Back</button>
                  <button type="submit" className="next-btn">Next</button>
                </div>
              </form>
            )}
            ...
            {collegeStep === 3 && (
              <form onSubmit={handleCollegeSubmit}>
                ...
                <div className="summary">
                  ...
                  <p><strong>College Name:</strong> {collegeFormData.collegeName}</p>
                  <p><strong>Registration No:</strong> {collegeFormData.registrationNo}</p>
                  <p><strong>Email:</strong> {collegeFormData.email}</p>
                  <p><strong>Phone:</strong> {collegeFormData.phone}</p>
                  <p><strong>State:</strong> {collegeFormData.state}</p>
                  <p><strong>Estd Year:</strong> {collegeFormData.yearOfEstablishment}</p>
                  <p><strong>Director Name:</strong> {collegeFormData.directorName}</p>
                  <p><strong>Director Email:</strong> {collegeFormData.directorEmail}</p>
                  <p><strong>Director Contact:</strong> {collegeFormData.directorContact}</p>
                  <p><strong>POC Name:</strong> {collegeFormData.poCName}</p>
                  <p><strong>POC Designation:</strong> {collegeFormData.designation}</p>
                  <p><strong>POC Email:</strong> {collegeFormData.poCEmail}</p>
                  <p><strong>POC Contact:</strong> {collegeFormData.poCMobile}</p>
          ...
          <div className="multi-step-form">
            ...
            {recruiterStep === 2 && (
              <form onSubmit={(e) => { e.preventDefault(); nextRecruiterStep(); }}>
                ...
                <div className="form-buttons">
                  <button type="button" className="prev-btn" onClick={prevRecruiterStep}>Back</button>
                  <button type="submit" className="next-btn">Next</button>
                </div>
              </form>
            )}
            ...
            {recruiterStep === 3 && (
              <form onSubmit={handleRecruiterSubmit}>
                ...
                <div className="summary">
                  <h3>Review Your Information</h3>
                  <p><strong>Company Name:</strong> {recruiterFormData.companyName}</p>
                  <p><strong>Recruiter Name:</strong> {recruiterFormData.recruiterName}</p>
                  <p><strong>Designation:</strong> {recruiterFormData.designation}</p>
                  <p><strong>Category:</strong> {recruiterFormData.category}</p>
                </div>
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="submit-btn">Register as Student</button>
      </form>
    </>
  );
};
